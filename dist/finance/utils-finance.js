...
function getQuarterDateRange(quarter, year) {
    ...
    switch (quarter) {
        ...
        case enums_finance_1.QuarterPeriod.Q4:
            return [
 ...
 */
function getQuarterFromDate(inputDate) {
    ...
    if (month < 3)
        return enums_finance_1.QuarterPeriod.Q1;
    if (month < 6)
        return enums_finance_1.QuarterPeriod.Q2;
    if (month < 9)
        return enums_finance_1.QuarterPeriod.Q3;
    return enums_finance_1.QuarterPeriod.Q4;
}
/**
